...
trainset = torchvision.datasets.CIFAR100(
    root='./cifar_100_data', train=True, download=True, transform=transform_train)
trainloader = torch.utils.data.DataLoader(
    trainset, batch_size=128, shuffle=True, num_workers=2)

testset = torchvision.datasets.CIFAR100(
    root='./cifar_100_data', train=False, download=True, transform=transform_test)
...
if net_str == "resnet18_update":
    net = ResNet18Update(num_classes = 100)
if net_str == "lenet5":
    net = LeNet5(num_classes = 100)
if net_str == "resnet50":
...
if os.path.isdir("checkpoint/") == 0:
    os.mkdir("checkpoint/")
if os.path.isdir("checkpoint/cifar100/") == 0:
    os.mkdir("checkpoint/cifar100/")
parent_folder = "checkpoint/cifar100/" + optimizer_method
