...
if __name__ == "__main__":
    ...
    model_str = "SimpleDNN"
    # model_str = "SimpleDNNUpdate"
    if model_str == "SimpleDNNUpdate":
        limiting_flag = 1
    else:
        limiting_flag = 0
    ...
    if optim_ == "Adam/":
        ...
        for _ in range(num_iter):
            ...
            os.system(f"python train_mnist.py --optim_ {optim_} --lr {lr} --beta_1 {beta_1} --beta_2 {beta_2} --t_max {t_max} --seed {seed_} --model_str {model_str} --csv_path {csv_path}")
    ...
    # Generating cases for SGD optimizer
        ...
        for _ in range(num_iter):
            ...
            os.system(f"python train_mnist.py --optim_ {optim_}  --lr {lr} --wd {wd} --t_max {t_max} --seed {seed_} --model_str {model_str} --csv_path {csv_path}")
    ...
    #Generating cases for AdaGrad optimizer
        ...
        for _ in range(num_iter):
            ...
            os.system(f"python train_mnist.py --optim_ {optim_}  --lr {lr} --wd {wd} --ld {ld} --seed {seed_} --model_str {model_str} --csv_path {csv_path}")
    ...
    # Generating cases for RMSprop optimizer
        ...
        for _ in range(num_iter):
            ...
            wd = 10 ** random.randint(-8, -1)
            os.system(f"python train_mnist.py --optim_ {optim_}  --lr {lr} --alpha {alpha} --wd {wd} --seed {seed_} --model_str {model_str} --csv_path {csv_path}")
    ...
    # Generating cases for EC optimizer
        ...
        for _ in range(num_iter):
            ...
            seed_ = random.randint(1,100)
            os.system(f"python train_mnist.py --optim_ {optim_}  --alpha_0 {alpha_0}  --eta {eta} --seed {seed_} --model_str {model_str} --csv_path {csv_path} --limiting_flag {limiting_flag}")
